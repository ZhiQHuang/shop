	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" style="margin-top: 5px;" id="Form">
					...
					<div class="form-group">
						<label for="addr" class="col-sm-2 control-label">邮编</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="code" name="code" placeholder="请输入邮编">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label">验证码</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" id="checkcode" name="checkcode" placeholder="请输入验证码" onblur="javascript:verifycode();">

						</div>
						<div class="col-sm-2">
							<img id="img1" src="index/verifycode" />
						</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="button" width="100" value="注册" name="submit" id="reg"
