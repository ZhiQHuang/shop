...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t<h1>登录 - 商城后台</h1>\r\n");
      out.write("\t\t\t<form method=\"post\" class=\"well\" action=\"adminLogin\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"uid\" class=\"span2\" placeholder=\"请输入用户名\" /><br />\r\n");
      out.write("\t\t\t\t<input type=\"password\" name=\"password\" class=\"span2\" placeholder=\"请输入密码\" /><br />\r\n");
      out.write("\t\t\t\t<label class=\"checkbox\"> <input type=\"checkbox\" name=\"remember\"/> 记住密码 </label>\r\n");
